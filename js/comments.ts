...
export const initializeComments = (): void => {
  ...
  if (
    !elements.showHideBtn ||
    !elements.commentWrapper ||
    !elements.form ||
    !elements.nameField ||
    !elements.commentField ||
    !elements.list
  ) {
  ...
  const toggleComments = (): void => {
    ...
    elements.commentWrapper!.style.display = isCommentsVisible
      ? 'block'
      : 'none';
    elements.showHideBtn!.textContent = isCommentsVisible
      ? 'Hide comments'
      : 'Show comments';
